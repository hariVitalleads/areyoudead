...
import com.areyoudead.user.dto.UserResponse;
...
public class AuthService {
	...
	public AuthResponse register(RegisterRequest req) {
		...
		try {
			...
			registrationRepository.save(new Registration(saved.getId(), "STANDARD", false, null));
			log.info("Registration success userId={} email={}", saved.getId(), saved.getEmail());
			String token = jwtService.createAccessToken(saved);
			return new AuthResponse(token, new UserResponse(saved.getId(), saved.getEmail(), saved.getCreatedAt()));
